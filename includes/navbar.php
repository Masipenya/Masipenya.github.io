  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="" class="navbar-brand"><b>АИС</b> Библиотека</a>
          ...
          <?php
            if(isset($_SESSION['student'])){
              echo "
                ...
                <li><a href='transaction.php'>Операции</a></li>
              ";
            } 
          ?>
        </ul>
        ...
        <ul class="nav navbar-nav">
          <?php
            if(isset($_SESSION['student'])){
              ...
              echo "
                <li><a href='#login' data-toggle='modal'><i class='fa fa-sign-in'></i> Войти</a></li>
                <li><a href='admin\index.php' ><i class='fa fa-sign-in'></i> Войти как админ</a></li>
              ";
            } 
          ?>
        </ul>
