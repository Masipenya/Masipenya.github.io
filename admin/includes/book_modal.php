    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Добавить новую книгу</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">Издатель</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Дата издания</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Редактировать</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">Название</label>
                ...
                <div class="form-group">
                    <label for="category" class="col-sm-3 control-label">Категории</label>
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">Автор</label>
                ...
                <div class="form-group">
                    <label for="edit_publisher" class="col-sm-3 control-label">Издатель</label>
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Дата издания</label>
